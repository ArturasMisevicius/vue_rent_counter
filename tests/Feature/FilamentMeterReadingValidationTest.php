...
test('Filament rejects missing meter_id', function () {
    $tenantId = 1;
    ...
    $component->call('create')
        ->assertHasFormErrors(['meter_id' => 'required']);
});

test('Filament rejects negative value', function () {
    $tenantId = 1;
...
test('Filament rejects monotonicity violation', function () {
    $tenantId = 1;
...
test('Filament accepts valid meter reading', function () {
    $tenantId = 1;
