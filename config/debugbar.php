...
return [
    ...
    'storage' => [
        ...
        'username'   => env('DEBUGBAR_STORAGE_USERNAME', ''),
        'password'   => env('DEBUGBAR_STORAGE_PASSWORD', ''),
        'database'   => env('DEBUGBAR_STORAGE_DATABASE', null),
        'token'      => env('DEBUGBAR_STORAGE_TOKEN', null),
    ],
    ...
    */
    ...
    /*
     ...
     |
     */
    'error_handler' => env('DEBUGBAR_ERROR_HANDLER', true),
