...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="mb-8">
            ...
            <p class="text-slate-600 mt-2">Update organization information</p>
        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="w-full px-3 py-2 border border-slate-300 rounded bg-slate-100 font-mono"
                                disabled
                            >
                            <p class="mt-1 text-xs text-slate-500">Tenant ID cannot be changed</p>
                        </div>
                    </div>
                </div>
        ...
        <x-card class="mt-6">
            <h2 class="text-lg font-semibold text-slate-900 mb-4">Subscription Management</h2>
