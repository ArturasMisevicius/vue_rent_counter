<div class="space-y-4">
    <div>
        <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">Action Information</h3>
        ...
        <div>
            ...
            <div class="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
                @if($record->before_data)
                    <div>
                        <h4 class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Before</h4>
                ...
                @if($record->after_data)
                    <div>
                        <h4 class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">After</h4>
