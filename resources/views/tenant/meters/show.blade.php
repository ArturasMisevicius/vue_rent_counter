...
<x-tenant.page
    ...
    :description="__('tenant.meters.show_description', ['type' => enum_label($meter->type), 'property' => $meter->property->address ?? __('tenant.property.title')])"
>
    <x-slot name="actions">
