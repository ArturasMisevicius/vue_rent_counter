    ...
    <section class="rounded-[2rem] border border-white/60 bg-white/92 p-8 shadow-[0_28px_90px_rgba(15,23,42,0.18)] backdrop-blur">
        ...
        <div class="mt-8 space-y-4">
            ...
            <div class="space-y-3">
                ...
                @empty
                    <x-ui.empty-state
                        heading="No meters are assigned to this property yet."
                        body="Once meters are assigned, you'll see their latest readings here and can jump directly to submission."
                    />
                @endforelse
            </div>
        </div>
