...
@section('title', __('tenant.profile.title') . ' · ' . config('app.name', 'Tenanto'))
    ...
    <main class="mx-auto max-w-6xl py-8">
        <div class="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <section class="space-y-6 rounded-[2rem] border border-white/60 bg-white/92 p-8 shadow-[0_28px_90px_rgba(15,23,42,0.18)] backdrop-blur">
                <div class="space-y-3">
                    <p class="text-sm font-semibold uppercase tracking-[0.24em] text-brand-warm">{{ __('shell.profile') }}</p>
