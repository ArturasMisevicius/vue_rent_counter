<x-layouts.app
    ...
    :subtitle="__('tenant.pages.profile.description')"
    ...
    <div class="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <section class="space-y-6 rounded-[2rem] border border-white/60 bg-white/92 p-8 shadow-[0_28px_90px_rgba(15,23,42,0.18)] backdrop-blur">
            <x-shared.form-section
                :title="__('tenant.pages.profile.page_heading')"
                :description="__('tenant.pages.profile.description')"
            >
                @if (session('status') === 'tenant-profile-updated')
                    <x-shared.alert type="success" :message="__('tenant.pages.profile.success')" dismissable />
                @endif
        ...
        <section class="space-y-6 rounded-[2rem] border border-white/60 bg-white/92 p-8 shadow-[0_28px_90px_rgba(15,23,42,0.18)] backdrop-blur">
            <x-shared.form-section
                :title="__('tenant.pages.profile.password_heading')"
                :description="__('tenant.pages.profile.password_description')"
            >
                @if (session('status') === 'tenant-password-updated')
                    <x-shared.alert type="success" :message="__('tenant.pages.profile.password_success')" dismissable />
                @endif
