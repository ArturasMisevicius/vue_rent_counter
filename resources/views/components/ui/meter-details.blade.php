<x-ui.stack>
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <x-ui.stat-card :label="__('shared.tenant.meter_details.stat.service')" :value="$meter->getServiceDisplayName()" />
        <x-ui.stat-card :label="__('shared.tenant.meter_details.stat.latest_reading')" :value="$latestReading ? number_format($latestReading->getEffectiveValue(), 2) . ' ' . $unit : __('shared.tenant.meter_details.not_recorded_yet')" :value-color="$latestReading ? 'text-indigo-700' : 'text-slate-500'" />
        <x-ui.stat-card :label="__('shared.tenant.meter_details.stat.last_updated')" :value="$latestReading ? $latestReading->reading_date->format('Y-m-d') : '-'" />
    </div>

    <x-ui.section-card :title="__('shared.tenant.meter_details.trend.title')" :description="__('shared.tenant.meter_details.trend.description')">
    ...
    <x-ui.section-card :title="__('shared.tenant.meter_details.monthly.title')" :description="__('shared.tenant.meter_details.monthly.description')">
    ...
    <x-ui.section-card :title="__('shared.tenant.meter_details.overview_title')" :description="__('shared.tenant.meter_details.overview_description')">
    ...
    <x-ui.section-card :title="__('shared.tenant.meter_details.recent_title')" :description="__('shared.tenant.meter_details.recent_description')">
