...
<div {{ $attributes->class([
    ...
    'border-amber-200 bg-amber-50' => $type === 'warning',
    'border-rose-200 bg-rose-50' => $type === 'error',
    'border-emerald-200 bg-emerald-50' => $type === 'success',
    'border-sky-200 bg-sky-50' => ! in_array($type, ['warning', 'error', 'success'], true),
]) }}>
    <div @class([
        ...
        'bg-sky-500' => ! in_array($type, ['warning', 'error', 'success'], true),
    ])></div>
    ...
    <div @class([
        ...
        'text-sky-900' => ! in_array($type, ['warning', 'error', 'success'], true),
    ])>
        <div class="flex-shrink-0">
            <svg @class([
                ...
                'text-sky-500' => ! in_array($type, ['warning', 'error', 'success'], true),
            ]) viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="{{ match($type) {
