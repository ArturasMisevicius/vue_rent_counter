...
@endif
    <div @class([
        'relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white/90 shadow-lg shadow-slate-200/60 transition',
        'group-hover:-translate-y-0.5 group-hover:shadow-xl' => $href,
    ])>
        ...
        <div class="relative p-5">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <p class="truncate text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">
                        {{ $label ?? $title }}
                    </p>
