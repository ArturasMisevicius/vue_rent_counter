...
>
    ...
    {{-- Quick Actions --}}
    <x-card class="mb-8">
        <h2 class="text-xl font-semibold">{{ __('superadmin.dashboard.quick_actions.title') }}</h2>
        <p class="mb-4 text-sm text-slate-500">{{ __('superadmin.dashboard.quick_actions.description') }}</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <a href="{{ route('superadmin.organizations.index') }}" class="group block focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-100 rounded-2xl">
            <x-card class="h-full group-hover:-translate-y-0.5 group-hover:shadow-xl transition duration-200">
                <h2 class="text-xl font-semibold">{{ __('superadmin.dashboard.organizations.title') }}</h2>
                <p class="mb-4 text-sm text-slate-500">{{ __('superadmin.dashboard.organizations.description') }}</p>
                <div class="space-y-3">
        ...
        <a href="{{ route('superadmin.subscriptions.index') }}" class="group block focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-100 rounded-2xl">
            <x-card class="h-full group-hover:-translate-y-0.5 group-hover:shadow-xl transition duration-200">
                <h2 class="text-xl font-semibold">{{ __('superadmin.dashboard.subscription_plans.title') }}</h2>
                <p class="mb-4 text-sm text-slate-500">{{ __('superadmin.dashboard.subscription_plans.description') }}</p>
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <x-card>
            <h2 class="text-xl font-semibold">{{ __('superadmin.dashboard.organizations.top_by_properties') }}</h2>
            <p class="mb-4 text-sm text-slate-500">{{ __('superadmin.dashboard.organizations.top_by_properties_description') }}</p>
            <div class="space-y-3">
        ...
        <x-card id="recent-activity">
            <h2 class="text-xl font-semibold">{{ __('superadmin.dashboard.recent_activity.title') }}</h2>
            <p class="mb-4 text-sm text-slate-500">{{ __('superadmin.dashboard.recent_activity.description') }}</p>
            <div class="space-y-3">
    ...
    <x-card class="mb-8" id="analytics">
        ...
        <p class="text-sm text-slate-500 mb-2">{{ __('superadmin.dashboard.analytics.description') }}</p>
