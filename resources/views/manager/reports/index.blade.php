...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-slate-700">Analytics and insights for your managed units</p>
        </div>
    </div>
    ...
    <div class="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <x-stat-card>
            ...
            <x-slot name="label">Properties</x-slot>
        ...
        <x-stat-card>
            ...
            <x-slot name="label">Readings This Month</x-slot>
        ...
        <x-stat-card>
            ...
            <x-slot name="label">Invoices This Month</x-slot>
    ...
    <div class="mt-8">
        <x-card>
            <x-slot name="title">How to use these reports</x-slot>
            
            <div class="mt-4 space-y-3 text-sm text-slate-600">
                <p><strong class="text-slate-900">Consumption:</strong> Compare usage month-over-month, filter by property or building, and export trends for provider reviews. Includes meter type breakdowns and top consuming properties.</p>
                <p><strong class="text-slate-900">Revenue:</strong> Validate invoicing progress before closing the period and ensure overdue balances are visible. Track payment rates and revenue by building.</p>
                <p><strong class="text-slate-900">Compliance:</strong> Identify meters without current readings and redirect your team to the right properties. Monitor compliance rates by building and meter type.</p>
            </div>
        </x-card>
    </div>
</div>
