...
@section('title', __('invoices.manager.drafts.title'))
...
<div class="px-4 sm:px-6 lg:px-8">
    <x-breadcrumbs>
        ...
        <x-breadcrumb-item :active="true">{{ __('invoices.manager.drafts.title') }}</x-breadcrumb-item>
    </x-breadcrumbs>

    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold text-slate-900">{{ __('invoices.manager.drafts.title') }}</h1>
            <p class="mt-2 text-sm text-slate-700">{{ __('invoices.manager.drafts.description') }}</p>
        </div>
