...
>
    ...
    @if(auth()->user()->role->value === 'admin')
        ...
        <div class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <x-stat-card :label="__('dashboard.admin.stats.total_buildings')" :value="$stats['total_buildings']">
                <x-slot:icon>
            ...
            <x-stat-card :label="__('dashboard.admin.stats.total_tenants')" :value="$stats['total_tenants']">
                <x-slot:icon>
                    <svg class="h-6 w-6 text-slate-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <x-stat-card :label="__('dashboard.admin.stats.draft_invoices')" :value="$stats['draft_invoices']">
                <x-slot:icon>
                    <svg class="h-6 w-6 text-slate-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <x-stat-card :label="__('dashboard.admin.stats.readings_last_7_days')" :value="$stats['recent_readings_count']">
                <x-slot:icon>
                    <svg class="h-6 w-6 text-slate-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    @else
        ...
        <div class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <x-stat-card :label="__('dashboard.admin.stats.utility_providers')" :value="$stats['total_providers']">
                <x-slot:icon>
                    <svg class="h-6 w-6 text-slate-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <x-stat-card :label="__('dashboard.admin.stats.active_tariffs')" :value="$stats['active_tariffs']">
                <x-slot:icon>
                    <svg class="h-6 w-6 text-slate-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
