...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold text-gray-900">Create Provider</h1>
            <p class="mt-2 text-sm text-gray-700">Add a new utility service provider</p>
        </div>
    </div>
        ...
        <x-card>
            <form action="{{ route('admin.providers.store') }}" method="POST">
                ...
                <div class="mt-6 flex items-center justify-end gap-x-3">
                    <a href="{{ route('admin.providers.index') }}" class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                        Cancel
                    </a>
