...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($languages) && $languages->isNotEmpty()): ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($variant === 'select'): ?>
        <div class="inline-flex <?php echo e($class ?? ''); ?>">
            <form method="GET" action="<?php echo e(route('language.switch', ['locale' => ''])); ?>" class="inline-flex">
                <label for="language-select" class="sr-only"><?php echo e(__('common.select_language')); ?></label>
                <select
                    id="language-select"
                    name="locale"
                    data-language-switcher="true"
                    data-base-url="<?php echo e(route('language.switch', ['locale' => ''])); ?>"
                ...
                >
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                            ...
                            <?php echo e($language->code === $currentLocale ? 'selected' : ''); ?>

                        >
                            <?php echo e($showLabels ?? true ? ($language->native_name ?? $language->name) : strtoupper($language->code)); ?>
    ...
    <?php else: ?>
        ...
        <div class="relative inline-block text-left <?php echo e($class ?? ''); ?>" x-data="{ open: false }">
            <button
                @click="open = !open"
            ...
            >
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a
                        ...
                        class="block px-4 py-2 text-sm <?php echo e($isActive ? 'bg-gray-100 text-gray-900 font-semibold' : 'text-gray-700 hover:bg-gray-50'); ?>"
                        role="menuitem"
                        @click="open = false"
                        <?php if($isActive): ?>
                            aria-current="true"
