...
<div <?php echo e($attributes->merge(['class' => 'relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white/95 shadow-lg shadow-slate-200/70 backdrop-blur-sm'])); ?>>
    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        <div class="mb-4">
            ...
            <h2 class="text-lg font-semibold text-slate-900"><?php echo e($title); ?></h2>
...
<?php /**PATH C:\www\rent_counter\resources\views/components/tenant/section-card.blade.php ENDPATH**/ ?>