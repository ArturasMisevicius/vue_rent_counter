...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['header' => null, 'caption' => null]));
...
foreach (array_filter((['header' => null, 'caption' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="overflow-x-auto rounded-2xl border border-slate-200/80 shadow-lg shadow-slate-200/60">
    <table <?php echo e($attributes->merge(['class' => 'min-w-full divide-y divide-slate-200'])); ?> role="table">
...
<?php /**PATH C:\www\rent_counter\resources\views/components/data-table.blade.php ENDPATH**/ ?>