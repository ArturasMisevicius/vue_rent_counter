...
<head>
    ...
    <title><?php echo e(__('error_pages.403.title')); ?></title>
        ...
        <div class="max-w-md w-full space-y-8 text-center">
            <div>
                ...
                <h2 class="mt-6 text-3xl font-extrabold text-slate-900">
                    <?php echo e(__('error_pages.403.headline')); ?>

                </h2>
                <p class="mt-2 text-sm text-slate-600">
                    <?php echo e(__('error_pages.403.description')); ?>

                </p>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($exception) && $exception->getMessage()): ?>
            ...
            <div class="mt-8 space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                        <?php echo e(__('error_pages.common.login')); ?>
                ...
                <div>
                    <a href="<?php echo e(url('/')); ?>" class="text-indigo-600 hover:text-indigo-500">
                        <?php echo e(__('error_pages.common.return_home')); ?>
...
<?php /**PATH C:\www\rent_counter\resources\views/errors/403.blade.php ENDPATH**/ ?>