...
interface CircuitBreakerInterface
{
     ...
     * @return array{service: string, state: string, failure_count: int, success_count: int, open_since: ?Carbon}
     */
     ...
     *
     * @return array<array{service: string, state: string, failure_count: int, success_count: int, open_since: ?Carbon}>
     */
