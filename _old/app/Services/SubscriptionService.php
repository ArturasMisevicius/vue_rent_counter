...
class SubscriptionService
{
    ...
    /**
     * Create or refresh the active subscription for an admin user.
     *
     * @param  User  $admin  The admin user who owns the subscription
     * @param  string|SubscriptionPlanType  $planType  The selected plan
     * @param  Carbon  $expiresAt  The expiration date for the subscription
     */
    public function createOrRefreshSubscription(
        User $admin,
