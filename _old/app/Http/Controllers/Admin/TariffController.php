...
final class TariffController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('pages.tariffs.index', compact('tariffs'));
    }
    ...
    public function create(): View
    {
        ...
        return view('pages.tariffs.create', compact('providers'));
    }
    ...
    public function show(Tariff $tariff): View
    {
        ...
        return view('pages.tariffs.show', compact('tariff', 'versionHistory'));
    }
    ...
    public function edit(Tariff $tariff): View
    {
        ...
        return view('pages.tariffs.edit', compact('tariff', 'providers'));
    }
