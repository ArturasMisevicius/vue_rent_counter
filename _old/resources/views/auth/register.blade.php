...
<head>
    ...
    <title>{{ $showBrandProduct ? __('app.auth.register_page.meta_title', ['brand' => $brandName, 'product' => $brandProduct]) : __('app.auth.register_page.meta_title_brand_only', ['brand' => $brandName]) }}</title>
