                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <a href="{{ route('superadmin.properties.edit', $property) }}" class="inline-flex items-center rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-semibold text-amber-700 transition hover:bg-amber-100">{{ __('common.edit') }}</a>
                ...
                @forelse($properties as $property)
                    <x-ui.list-record :title="$property->address" :subtitle="$property->type?->label()">
                        ...
                        <x-slot name="actions">
                            ...
                            <a href="{{ route('superadmin.properties.edit', $property) }}" class="inline-flex w-full items-center justify-center rounded-2xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                {{ __('common.edit') }}
                            </a>
                            <form action="{{ route('superadmin.properties.destroy', $property) }}" method="POST" onsubmit="return confirm('{{ __('common.confirm_delete') }}');" class="w-full">
                                @csrf
                                @method('DELETE')
