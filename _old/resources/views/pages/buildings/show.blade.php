...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="space-x-2">
            <a href="{{ route('superadmin.buildings.edit', $building) }}" class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700">{{ __('common.edit') }}</a>
            <form action="{{ route('superadmin.buildings.destroy', $building) }}" method="POST" class="inline">
                @csrf
                @method('DELETE')
        ...
        <x-card>
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p class="text-sm text-slate-500">{{ __('buildings.pages.superadmin_show.sections.properties_description') }}</p>
                </div>
            </div>
                        ...
                        @forelse($properties as $property)
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-right space-x-2">
                                    ...
                                    <a href="{{ route('superadmin.properties.edit', $property) }}" class="inline-flex items-center px-3 py-1 rounded-md text-xs font-semibold text-amber-700 bg-amber-50 hover:bg-amber-100">{{ __('common.edit') }}</a>
        ...
        <x-card>
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p class="text-sm text-slate-500">{{ __('buildings.pages.superadmin_show.sections.meters_description') }}</p>
                </div>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
