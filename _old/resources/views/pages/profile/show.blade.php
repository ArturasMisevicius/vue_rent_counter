    ...
    <x-card :title="__('profile.shared.profile_form.title')" class="divide-y divide-slate-100">
        ...
        <form method="POST" action="{{ route('superadmin.profile.update') }}" class="space-y-5">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white/90 px-4 py-2.5 text-sm font-semibold tracking-tight text-slate-800 shadow-sm transition duration-150 hover:bg-white">
