...
- Do not duplicate translation values: before adding a new key, reuse an existing key with the same meaning/value (use shared keys when text is reused across modules).
