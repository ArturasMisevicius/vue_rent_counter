...
- [x] 12.1 Add filters to resources
...
- [x] 12.2 Add search functionality
...
- [x] 12.3 Add bulk actions where appropriate
...
- [x] 13. Clean up obsolete frontend configuration




- [x] 13.1 Remove Vue.js configuration files
...
- [x] 13.2 Simplify Vite configuration
