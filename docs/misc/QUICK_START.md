...
1. **Read the Documentation**:
   - [design/README.md](../overview/readme.md) - Overview
   - [design/INTEGRATION_GUIDE.md](../guides/INTEGRATION_GUIDE.md) - Detailed setup
...
3. **Start Migrating**:
   - Follow [design/MIGRATION_PLAN.md](MIGRATION_PLAN.md)
...
Need help? Check:
1. [design/INTEGRATION_GUIDE.md](../guides/INTEGRATION_GUIDE.md)
2. [design/COMPONENT_AUDIT.md](COMPONENT_AUDIT.md)
3. [design/MIGRATION_PLAN.md](MIGRATION_PLAN.md)
