...
2. **Configure Tailwind** (see [INTEGRATION_GUIDE.md](../guides/INTEGRATION_GUIDE.md))
...
- [INTEGRATION_GUIDE.md](../guides/INTEGRATION_GUIDE.md) for setup help
- [COMPONENT_AUDIT.md](../misc/COMPONENT_AUDIT.md) for current state
- [MIGRATION_PLAN.md](../misc/MIGRATION_PLAN.md) for migration strategy
