...
- Migration guide in [/design/MIGRATION_PLAN.md](../misc/MIGRATION_PLAN.md)
- Integration guide in [/design/INTEGRATION_GUIDE.md](../guides/INTEGRATION_GUIDE.md)
...
Refer to:
1. [design/INTEGRATION_GUIDE.md](../guides/INTEGRATION_GUIDE.md) for setup help
2. [design/COMPONENT_AUDIT.md](../misc/COMPONENT_AUDIT.md) for current state
3. [design/MIGRATION_PLAN.md](../misc/MIGRATION_PLAN.md) for migration strategy
