...
1. Review [COMPONENT_AUDIT.md](../misc/COMPONENT_AUDIT.md) for available components
2. Check [MIGRATION_PLAN.md](../misc/MIGRATION_PLAN.md) for migration strategy
...
2. Check migration plan in [MIGRATION_PLAN.md](../misc/MIGRATION_PLAN.md)
