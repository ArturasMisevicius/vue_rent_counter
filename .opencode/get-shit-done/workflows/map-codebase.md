...
```bash
INIT=$(node "/Users/andrejprus/Herd/tenanto/.opencode/get-shit-done/bin/gsd-tools.cjs" init map-codebase)
...
```bash
node "/Users/andrejprus/Herd/tenanto/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
