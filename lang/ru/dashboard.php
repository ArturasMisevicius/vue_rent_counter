...
return [
    'admin' => [
        ...
        'badges' => [
            'admin' => 'Рабочее пространство администратора',
            'platform' => 'Операции платформы',
        ],
        ...
        'quick_actions' => [
            ...
            'manage_tariffs_desc' => 'Настройка тарифов коммунальных услуг',
            ...
            'view_audit_log_desc' => 'История системной активности',
        ...
        'stats' => [
            ...
            'draft_invoices' => 'Черновики счетов',
            'readings_last_7_days' => 'Показания (за 7 дней)',
    ...
    'tenant' => [
        ...
        'space_label' => 'Пространство арендатора',
        'stats' => [
            'active_meters' => 'Активные счетчики',
