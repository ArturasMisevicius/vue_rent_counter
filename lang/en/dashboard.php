...
return [
    ...
    'audit' => [
        ...
        'no_changes_description' => 'There are no recent changes to display.',
        ...
        'anomaly_marked_investigating' => 'The anomaly is marked as under investigation',
        'anomaly_resolved' => 'Anomaly resolved',
        'anomaly_ignored' => 'Anomaly ignored',
        'status' => 'Status',
        'last_check' => 'Last check',
        'issues' => 'Problems',
        'no_issues' => 'There are no problems',
    ],
    'property' => 'Property',
    'service' => 'Service',
    'latest_reading' => 'Last reading',
    'no_readings' => 'There are no readings',
    'monthly_consumption' => 'Monthly consumption',
    'last_reading_date' => 'Date of last reading',
    'status' => 'Status',
    'no_data' => 'No data available',
    'recent' => 'The latest',
    'outdated' => 'Obsolete',
    'has_recent_readings' => 'Has the latest readings',
    'needs_reading' => 'Need a reading',
    'view_readings' => 'View readings',
    'export_readings' => 'Export readings',
    'export_started' => 'Export started',
    'export_will_be_available_shortly' => 'Export will be available soon',
    'navigation' => [
        'title' => 'Dashboard',
    ],
    'layout' => [
