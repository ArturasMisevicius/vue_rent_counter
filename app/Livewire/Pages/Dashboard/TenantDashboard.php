...
class TenantDashboard extends Component
{
    ...
    protected function defaultSummary(): array
    {
        return [
            ...
            'submit_reading_url' => null,
            'current_invoice' => null,
            'has_open_reading_request' => false,
            ...
            'current_month_metric' => __('tenant.pages.home.waiting_for_reading_request_metric'),
            'current_month_message' => __('tenant.pages.home.waiting_for_reading_request_message'),
            'consumption_by_type' => [],
