 ...
 * - Question length limits (10-255 chars)
 * - Category whitelist pattern
 * - Answer length limits (10-10000 chars)
    ...
    public function rules(): array
    {
        return [
            'question' => [
                ...
                'min:10',
                'max:255',
                'regex:/^[a-zA-Z0-9\s\?\.\,\!\-\(\)]+$/u', // Alphanumeric + basic punctuation
            ],
            'answer' => [
                'required',
                'string',
            ...
            'category' => [
                ...
                'string',
                'max:120',
                'regex:/^[a-zA-Z0-9\s\-\_]+$/u', // Alphanumeric, spaces, hyphens, underscores
            ],
            'display_order' => [
                'nullable',
                'integer',
