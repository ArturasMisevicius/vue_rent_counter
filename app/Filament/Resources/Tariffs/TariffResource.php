...
class TariffResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return parent::getEloquentQuery()
            ...
            ->whereHas('provider', fn (Builder $query): Builder => $query->where('organization_id', $organizationId))
            ->with([
    ...
    {
        $user = auth()->user();
        $record->loadMissing('provider:id,organization_id');

        return $record instanceof Tariff
            && $record->provider?->organization_id === app(OrganizationContext::class)->currentOrganizationId()
