...
class OrganizationResource extends Resource
{
    ...
    {
        return [
            // Avoid collisions with legacy `/superadmin/organizations*` web routes.
            'index' => Pages\ListOrganizations::route('/filament'),
            'create' => Pages\CreateOrganization::route('/filament/create'),
            'view' => Pages\ViewOrganization::route('/filament/{record}'),
            'edit' => Pages\EditOrganization::route('/filament/{record}/edit'),
        ];
    }
