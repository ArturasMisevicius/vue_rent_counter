...
final class InvoicePaymentConfirmedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        $this->payment->loadMissing([
            'invoice:id,organization_id,property_id,tenant_user_id,invoice_number,currency,total_amount,paid_amount,balance_amount,payment_status,due_date,paid_at',
        ]);

        return [
            'title' => __('admin.payments.notifications.confirmed_title'),
            'body' => __('admin.payments.notifications.confirmed_body', [
                'amount' => $this->amount(),
