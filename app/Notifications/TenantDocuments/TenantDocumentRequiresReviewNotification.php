...
class TenantDocumentRequiresReviewNotification extends Notification
{
    use Queueable;
    ...
    {
        return [
            'title' => __('notifications.tenant_documents.requires_review_title'),
            'body' => __('notifications.tenant_documents.requires_review_body', ['title' => $this->document->title]),
