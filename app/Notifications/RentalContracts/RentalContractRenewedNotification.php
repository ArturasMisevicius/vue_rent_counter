...
final class RentalContractRenewedNotification extends Notification
{
    use Queueable;
    ...
    {
        return [
            'title' => __('notifications.rental_contracts.renewed_title'),
            'body' => __('notifications.rental_contracts.renewed_body', [
