...
- Updated: Filament admin workflow, authorization behavior, documentation, and project automation.
<!-- changelog:auto:end:staged-20260615111915 -->
...
- added `app/Filament/Support/View/BladeViewData.php`
- updated `app/Livewire/Filament/ManagerPermissionMatrixPanel.php`
- updated `app/Livewire/Pages/Dashboard/AdminDashboard.php`
- updated `app/Livewire/Shell/Topbar.php`
- updated `app/Livewire/Tenant/InvoiceHistory.php`
- updated `app/Livewire/Tenant/PropertyDetails.php`
- updated `app/Providers/AppServiceProvider.php`
- added `app/View/Components/Framework/Alert.php`
- added `app/View/Components/Shared/Alert.php`
- added `app/View/Components/Shared/CalendarModal.php`
- added `app/View/Components/Shared/InvoiceSummary.php`
- added `app/View/Components/Shared/LanguageSwitcher.php`
- added `app/View/Components/Shared/StatusBadge.php`
- added `app/View/Components/Shared/TenantBottomNav.php`
- updated `app/View/Components/Shell/AppFrame.php`
- added `app/View/Components/Shell/Brand.php`
- added `app/View/Components/Shell/ErrorState.php`
- added `app/View/Components/Shell/SessionExpiryMonitor.php`
- added `app/View/Components/Shell/UserAvatar.php`
- added `app/View/Components/Superadmin/RevenueTrendChart.php`
- added `app/View/Components/Tenant/Action.php`
- added `app/View/Components/Tenant/Card.php`
- added `app/View/Components/Tenant/InvoiceCard.php`
- added `app/View/Components/Tenant/RecentReadings.php`
- added `build/assets/app-gujXmytC.css`
- removed `build/assets/app-l4tK1b-a.css`
- updated `build/manifest.json`
- updated `resources/views/auth/login.blade.php`
- updated `"resources/views/components/framework/221alert.blade.php"`
- updated `resources/views/components/shared/alert.blade.php`
- updated `resources/views/components/shared/calendar-modal.blade.php`
...
- updated `resources/views/components/shared/status-badge.blade.php`
...
- updated `resources/views/components/shell/brand.blade.php`
- updated `resources/views/components/shell/breadcrumbs.blade.php`
- updated `resources/views/components/shell/error-state.blade.php`
- updated `resources/views/components/shell/session-expiry-monitor.blade.php`
...
- updated `resources/views/components/tenant/action.blade.php`
- updated `resources/views/components/tenant/card.blade.php`
- updated `resources/views/components/tenant/invoice-card.blade.php`
- updated `resources/views/components/tenant/recent-readings.blade.php`
- updated `resources/views/errors/layout.blade.php`
- updated `resources/views/filament/pages/billing-cleanup-center.blade.php`
- updated `resources/views/filament/pages/billing-invoice-review.blade.php`
- updated `resources/views/filament/pages/billing-review-center.blade.php`
- updated `resources/views/filament/pages/generate-bulk-invoices.blade.php`
- updated `resources/views/filament/pages/lead-import.blade.php`
- updated `resources/views/filament/pages/partials/account-profile-sections.blade.php`
- updated `resources/views/filament/pages/settings.blade.php`
- updated `resources/views/filament/pages/system-configuration.blade.php`
- updated `resources/views/filament/pages/translation-management.blade.php`
- updated `resources/views/filament/resources/invoices/pages/view-invoice.blade.php`
- updated `resources/views/filament/resources/meters/widgets/meter-consumption-chart.blade.php`
- updated `resources/views/filament/resources/organizations/overview.blade.php`
...
- updated `resources/views/livewire/filament/manager-permission-matrix.blade.php`
- updated `resources/views/livewire/pages/dashboard/admin-dashboard.blade.php`
...
- added `scripts/check_view_hygiene.php`
- added `tests/Feature/Architecture/ViewHygieneGuardTest.php`
<!-- changelog:auto:end:staged-20260615071011 -->
...
- updated `.agent/ARCHITECTURE.md`
- updated `.agent/agents/orchestrator.md`
- added `.agent/agents/tenanto-mobile-responsive-auditor.md`
<!-- changelog:auto:end:staged-20260615064452 -->

<!-- changelog:auto:start:staged-20260615064058 -->
### Commit updates

- updated `.agent/ARCHITECTURE.md`
- updated `.agent/agents/orchestrator.md`
- added `.agent/agents/tenanto-css-blade-hygiene-auditor.md`
<!-- changelog:auto:end:staged-20260615064058 -->
